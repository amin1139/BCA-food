...
const RestaurantCard = ({ resData }) => {
  ...
  return (
    <div className="w-full max-w-sm rounded-lg overflow-hidden border border-transparent p-2 hover:shadow-lg transition-all duration-300 cursor-pointer dark:hover:shadow-black/40">
      ...
      <div className="pt-3">
        {/* Restaurant Name */}
        <h3 className="text-lg font-bold text-gray-800 truncate mb-1 dark:text-slate-100">
          {name}
        </h3>
        ...
        <div className="flex items-center gap-2 mb-1">
          <div className="flex items-center gap-1">
            ...
            <span className="text-sm font-semibold text-gray-800 dark:text-slate-200">{avgRating}</span>
          </div>
          <span className="text-gray-800 font-semibold dark:text-slate-200">|</span>
          <span className="text-sm font-semibold text-gray-800 dark:text-slate-200">{sla?.slaString}</span>
        </div>
